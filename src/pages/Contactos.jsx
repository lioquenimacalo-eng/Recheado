...
function Contacto() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      // ⚠️ SUBSTITUA pelos seus IDs reais do EmailJS
  ...
  formRef.current,
  {
    publicKey: '56DVN2IWDZWaqUvR8',
  }
);

      setStatusMessage({
        type: 'success',
        text: 'Mensagem enviada com sucesso! Entraremos em contacto em breve.'
      });
      ...
      setStatusMessage({
        type: 'error',
        text: 'Ocorreu um erro ao enviar a mensagem. Tente novamente ou contacte-nos diretamente.'
      });
    } finally {
          ...
          <div className="grid lg:grid-cols-5 gap-12">
            ...
            <div className="lg:col-span-3">
              <div className="bg-white rounded-3xl shadow-2xl p-10 md:p-16">
                <h2 className="text-4xl font-semibold mb-10 text-zinc-900">
                ...
                <form ref={formRef} onSubmit={handleSubmit} className="space-y-8">
                  ...
                  <div className="grid md:grid-cols-2 gap-6">
                    ...
                    <div>
                      ...
                      >
                        ...
                        <option value="Informacao">Busca de informações</option>
                  ...
                  <button
                    ...
                    className="w-full bg-orange-600 hover:bg-orange-700 disabled:bg-orange-400 disabled:cursor-not-allowed transition-all text-white py-5 rounded-2xl font-semibold text-lg flex items-center justify-center gap-3 group"
                  >
            ...
            <div className="lg:col-span-2 space-y-10">
              ...
              <div className="bg-zinc-900 text-white rounded-3xl p-10 space-y-10">
                <div className="flex gap-5">
                  ...
                  <div>
                    ...
                    <a href="tel:+244931555634" className="text-2xl hover:text-orange-400 transition-colors">
                      +244 931 555 634
                    </a>
                  </div>
                </div>
                ...
                <div className="flex gap-5">
                  ...
                  <div>
                    ...
                    <a href="mailto:geral@grupoyoung.ao" className="text-xl hover:text-orange-400 transition-colors">
                      geral@grupoyoung.ao
                    </a>
                  </div>
                </div>
                ...
                <div className="flex gap-5">
                  ...
                  <div>
                    ...
                    <p className="text-xl">
                      Luanda - Talatona (ao lado do Colégio Abílio Junqueira), Angola
                    </p>
                  </div>
                </div>
                ...
                <div className="flex gap-5">
                  ...
                  <div>
                    ...
                    <p>Seg - Sex: 24h<br />Sábado: 09h00 - 00h00</p>
                  </div>
                </div>
              </div>
              ...
              <div>
                ...
                <div className="grid grid-cols-2 gap-4">
                  <a
                    href="https://www.instagram.com/grupo_young_ao"
                    target="_blank"
                    rel="noopener noreferrer"
                    className="flex items-center gap-4 bg-zinc-100 hover:bg-zinc-200 transition-colors p-6 rounded-3xl group"
                  >
                  ...
                  <a
                    href="https://www.tiktok.com/@grupo.young.ao"
                    target="_blank"
                    rel="noopener noreferrer"
                    className="flex items-center gap-4 bg-zinc-100 hover:bg-zinc-200 transition-colors p-6 rounded-3xl group"
                  >
                  ...
                  <a
                    href="https://www.facebook.com/profile.php?id=61586371868104"
                    target="_blank"
                    rel="noopener noreferrer"
                    className="flex items-center gap-4 bg-zinc-100 hover:bg-zinc-200 transition-colors p-6 rounded-3xl group"
                  >
